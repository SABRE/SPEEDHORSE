    ...
    */
    function validateObjectAttributeHTTPInput( $http, $base, $contentObjectAttribute )
    {
             ...
             $http->hasPostVariable( $base . "_data_user_password_confirm_" . $contentObjectAttribute->attribute( "id" ) ) )
        {
            ...
            {
			////////////////////////////////////emailcheck for userlogin ///////////////////////////////////////
              if(trim( $loginName ) != '')
					{
						 $isValidate = eZMail::validate( $loginName );
						 if ( !$isValidate )
						{
							$contentObjectAttribute->setValidationError( ezpI18n::tr( 'kernel/classes/datatypes',
																				 'The user name is not valid, please use an email address as user name.' ) );
							return eZInputValidator::STATE_INVALID;
						}
					}
			  ///////////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    */
    function fetchObjectAttributeHTTPInput( $http, $base, $contentObjectAttribute )
    {
        if ( $http->hasPostVariable( $base . "_data_user_login_" . $contentObjectAttribute->attribute( "id" ) ) )
        {
            ...
            $email = $http->hasPostVariable( $base . "_data_user_login_" . $contentObjectAttribute->attribute( "id" ) ) ? $http->postVariable( $base . "_data_user_login_" . $contentObjectAttribute->attribute( "id" ) ) : '';
