        ...
        <div id="right_content">
            ...
            <div id="content_wrap">
            	<div id="sidebar_content">
                 ...
                 <div id="classify_top">
                <div id="classify_images_wrap">
            		<div id="classify_images">
                    	<div id="main_img">
						  <a href="#" id="image-1-a-img">{attribute_view_gui image_class=classifylisting_img attribute=$node.data_map.image}</a>
                           <a href="#" style="display:none;" id="image-2-a-img">{attribute_view_gui image_class=classifylisting_img attribute=$node.data_map.image1}</a>
                            <a href="#" style="display:none;" id="image-3-a-img">{attribute_view_gui image_class=classifylisting_img attribute=$node.data_map.image2}</a>
                            <a href="#" style="display:none;" id="image-4-a-img">{attribute_view_gui image_class=classifylisting_img attribute=$node.data_map.image3}</a>
 
                        </div><!--end id#main_img-->
                        <div id="images">
            				<a href="#" id="image-1-a">{attribute_view_gui attribute=$node.data_map.image}</a>
                            <a href="#" id="image-2-a">{attribute_view_gui attribute=$node.data_map.image1}</a>
                            <a href="#" id="image-3-a">{attribute_view_gui attribute=$node.data_map.image2}</a>
             				<a href="#" id="image-4-a">{attribute_view_gui attribute=$node.data_map.image3}</a>
							
                        </div><!--end id#images-->
                	</div><!--end div#classify_images-->
                </div><!--end div#classify_images_wrap-->
                </div>
