		...
		<div id="magazinemain"  >
            <div id="accordion_wrap">
				<div id="accordion">
					...
					<div id="curremagazine_wrap" style="background:#fffaf4;height:300px;">
							...
							<ul style="padding-left:5px; padding-top:2px;margin-right:10px;" class ="mainmagazine">
								...
								<li>
								{if eq($col,1)}
								<a href="#" class="myleftclass leftbaractive" id="ul_{$myemagazine.node_id}_div">{$myemagazine.name}</a>
								{else}
								<a href="#" class="myleftclass leftbarinactive" id="ul_{$myemagazine.node_id}_div">{$myemagazine.name}</a>
								{/if}
								{if $children_count}
							
									{if eq($col,1)}
										<ul style="padding-left:5px; padding-top:2px;padding-bottom:2px;" class="subemagazine subemagazineactive" id="subul_{$myemagazine.node_id}_div">
									{else}
									<ul style="padding-left:5px; padding-top:2px;padding-bottom:2px;" class="subemagazine" id="subul_{$myemagazine.node_id}_div">
									{/if}
									{set $dcol=1}
