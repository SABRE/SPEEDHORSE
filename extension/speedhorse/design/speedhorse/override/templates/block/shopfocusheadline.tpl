	...
	<div id="bottom_content_wrap">
				<div id="left_bottom_panel">
					...
					<ul class="speedhorse_list">
						<li><a href="#">regular headline will go here on one line</a></li>
						<li><a href="#">regular headline will go here on one line</a></li>
						<li><a href="#">regular headline will go here on one line</a></li>
						<li><a href="#">regular headline will go here on one line</a></li>
						<li><a href="#">regular headline will go here on one line</a></li>
					...
					<div class="post">
						<h4>section title</h4>
						<h3><a href="#">feature headline goes here</a></h3>
				...
				<div id="products_preview" class="post"><!--start div#products_preview-->
					...
					<div>
						<img src="../images/product_thumbnail.png" alt="product_thumbnail">
