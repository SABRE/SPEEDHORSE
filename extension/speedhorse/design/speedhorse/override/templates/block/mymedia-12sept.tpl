...
{def $valarticle=""}
                ...
                <script type="text/javascript" src="/extension/multimedia/design/standard/javascript/ezbotr_object.js"></script>
                    ...
                    {def $children2 = array()
                 	$children_count2 = ''}
                 	{set $children_count2=fetch_alias( 'children_count', hash( 'parent_node_id', '576') )}
       				 {if $children_count2}
                   			{foreach fetch_alias( 'children', hash( 'parent_node_id', '576')  ) as $child2}
											
                               	            <div class="thumb_link basic" id="thumb_{$child2.node_id}">
                                           {attribute_view_gui attribute=$child2.data_map.video_image data-fullsize=$child2.data_map.video_image}
                                                    
                                                        <div class="thumb_caption"></div>
                                                        <div class="thumb_frame" style="display:block;"></div>
                                                        <div class="image_caption">
                                                        <div class="large_image_caption"><h3>{attribute_view_gui attribute=$child2.data_map.description}</h3></div>
                                                        <div class="more_link_wrap"></div>
                                                    </div>
                                             </div>   
