...
<div class="block">
<label style="color:#0E4281;">{'Search all the words'|i18n( 'design/ezwebin/content/advancedsearch' )}</label><div class="labelbreak"></div>
<input class="box" type="text" size="40" name="SearchText" value="{$full_search_text|wash}" />
</div>
<div class="block">
<label style="color:#0E4281;">{'Search the exact phrase'|i18n( 'design/ezwebin/content/advancedsearch' )}</label><div class="labelbreak"></div>
...
<label style="color:#0E4281;">{'Published'|i18n( 'design/ezwebin/content/advancedsearch' )}</label><div class="labelbreak"></div>
...
{if $use_template_search}
<div class="element">
<label style="color:#0E4281;">{'Display per page'|i18n('design/ezwebin/content/advancedsearch')}</label><div class="labelbreak"></div>
