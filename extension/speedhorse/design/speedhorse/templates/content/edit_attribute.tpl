...
function phonecheck()
	{
		if(document.getElementById('ezcoa-467_office_phone_number').value=="" && document.getElementById('ezcoa-469_cell_phone_number').value=="" && document.getElementById('ezcoa-468_home_phone_number').value=="")
			{
			alert("Please enter any phone no.");
			return false;
			}
	return true;
	}	
