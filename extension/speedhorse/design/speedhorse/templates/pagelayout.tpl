...
<html xmlns="http://www.w3.org/1999/xhtml" xml:lang="{$site.http_equiv.Content-language|wash}" lang="{$site.http_equiv.Content-language|wash}" xmlns:fb="https://www.facebook.com/2008/fbml">
<head>
...
<div id="footer">
		<div id="credits_wrap">
			<h6 id="sabre_copyright"><a href="#">&copy;sabre publishing ltd. co. copyrights 2011</a></h6>
			<h6 id="ciplex_credit"></h6>
		</div>
	</div>
</body>
</html>