...
jQuery(document).ready(function($) {
	...
	if(document.getElementById('mymodeid').value == "node_id_0"){
		$.cookie("menubarcookies", 'node_id_217', { path: '/' });
		//alert(document.getElementById('mymodeid').value);
	}
	else if(document.getElementById('mymodeid').value != ""){
		$.cookie("menubarcookies", document.getElementById('mymodeid').value, { path: '/' });
		//alert(document.getElementById('mymodeid').value);
	}
	var mymenu=$.cookie("menubarcookies");
	if(mymenu!== undefined){
		
		$("#"+mymenu).removeClass("current_page");
		$("#"+mymenu+"a").removeClass("current_page");
		var achid=$("#"+mymenu+" a").attr('id');
		...
		//alert( $.cookie("menubarcookies") );
		$("#"+achid).addClass("current_page");
		
		
		//$("#"+mymenu).css({"background-image":"url(../images/bg_left.png)", "background-repeat":"no-repeat", "background-position":"left top"});
		//$("#"+mymenu).find("a.main").css({"background-image":"url(../images/bg_right.png)", "background-repeat":"no-repeat", "background-position":"right top","color":"#0E4281"});
  ...
  $("#calendar_items div.items").hide();
	...
	var id = $("ul#"+theImageId+" li:first").attr("id");
	 ...
	 /* for archieve magazine section */
	 
	 $("#aremagazine_wrap ul.subemagazine").hide();
	 
	 /* end of archieve magazine section on page load */
...
jQuery(function($){
	...
	$("#navigation li.main").click(function(){
		...
		$.cookie("menubarcookies", $(this).attr('id'), { path: '/' });
		...
		//var id=$(this).attr('id');
		//alert(id);
		//id=id.replace("a_node_id","subnav");
		//$(".subnav").hide();
...
$(".subnav").click(function(){
	...
	$("#archivedemagazine").click(function(){
...
$(".thumb_link").click(function(){
		...
		{
			$(".current_view .large_image_caption_wrap_video").text="";
			$(".current_view .large_image_caption_wrap_video").html="";
			var data=$(clicked).children(".image_caption").html();
			
			data=data.replace("<h3>","");
			data=data.replace("</h3>","");
			$(".current_view .large_image_caption_wrap_video").html(data);
			//alert($(clicked).children(".image_caption").html());
			//alert($("#"+id1).children(".image_caption").html());
		//	var id2=id1.replace("thumb","cap");
			//alert($("#"+id2).html());
...
$(".basic").click(function(){
		...
		$("#"+id1).show();
		alert($("#"+id1).html());
		$("#preview_pane").html('<div class="preview_content videos">');
		$("#preview_pane").html+=$("#"+id1).html();
		$("#preview_pane").html+='</div>';
...
$(".subemagazineli").click(function(){
	...
	/* end of emagazine archieve section*/
