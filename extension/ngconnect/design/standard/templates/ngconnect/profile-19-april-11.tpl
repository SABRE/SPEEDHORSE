...
<div class="ngconnect-profile">
	...
	{if $forced_redirect|not}
		...
		<p><strong>{'Please change your Password on First Login ( It is a good idea for you to change your password the first time you log in to site. You can do this by selecting "My Profile" then selecting "Edit Profile".)'|i18n('extension/ngconnect/ngconnect/profile')}</strong></p>
	{else}
