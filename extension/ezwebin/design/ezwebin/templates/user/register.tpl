...
function getElementsByType(array, type) {
	...
	function checked(form)
	{
		...
		if((document.getElementById('ezcoa-546_office_phone_number').value=='') && (document.getElementById('ezcoa-548_home_phone_number').value=='') && (document.getElementById('ezcoa-547_cell_phone_number').value==''))
			{
	...
	function workfill()
	{
		document.getElementById('ezcoa-546_office_phone_number')
	}
-->
</script>
{/literal}
