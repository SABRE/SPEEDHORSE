...
<tr>
    ...
    <th>
    {"Tax"|i18n("design/ezwebin/shop/basket")}
    </th>
    <th>
    {"Price inc. Tax"|i18n("design/ezwebin/shop/basket")}
    </th>
    <th>
    {"Discount"|i18n("design/ezwebin/shop/basket")}
    </th>
    <th>
    {"Total price ex. Tax"|i18n("design/ezwebin/shop/basket")}
    </th>
    <th>
    {"Total price inc. Tax"|i18n("design/ezwebin/shop/basket")}
    </th>
    <th>&nbsp;
    </th>
</tr>
...
<tr>
     ...
     <td>
     <strong>{"Subtotal ex. Tax"|i18n("design/ezwebin/shop/basket")}</strong>:
     </td>
     <td>
     <strong>{"Subtotal inc. Tax"|i18n("design/ezwebin/shop/basket")}</strong>:
     </td>
</tr>
<tr>
    <td colspan="5">
