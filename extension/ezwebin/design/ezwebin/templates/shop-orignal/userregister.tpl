...
<div class="block">
<label>
{"Address"|i18n("design/ezwebin/shop/userregister")}:
</label><div class="labelbreak"></div>
<textarea name="Street1" class="box">{$street1|wash}</textarea>
</div>
...
{include uri='design:shop/country/edit.tpl' select_name='Country'  current_val=$country}
</div>
