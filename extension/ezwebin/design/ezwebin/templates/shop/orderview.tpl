...
<tr>
    ...
    <th>
    {'Tax'|i18n( 'design/ezwebin/shop/orderview' )}
    </th>
    <th>
    {'Price inc. Tax'|i18n( 'design/ezwebin/shop/orderview' )}
    </th>
    <th>
    {'Discount'|i18n( 'design/ezwebin/shop/orderview' )}
    </th>
    <th>
    {'Total price ex. Tax'|i18n( 'design/ezwebin/shop/orderview' )}
    </th>
    <th>
    {'Total price inc. Tax'|i18n( 'design/ezwebin/shop/orderview' )}
    </th>
</tr>
