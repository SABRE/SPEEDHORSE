...
<tr>
    ...
    <th>
    {"Tax"|i18n("design/ezwebin/shop/confirmorder")}
    </th>
    <th>
    {"Price inc. Tax"|i18n("design/ezwebin/shop/confirmorder")}
    </th>
    <th>
    {"Discount"|i18n("design/ezwebin/shop/confirmorder")}
    </th>
    <th>
    {"Total price ex. Tax"|i18n("design/ezwebin/shop/confirmorder")}
    </th>
    <th>
    {"Total price inc. Tax"|i18n("design/ezwebin/shop/confirmorder")}
    </th>
</tr>
...
<tr>
    ...
    <th>{"Total ex. Tax"|i18n("design/ezwebin/shop/confirmorder")}</th>
    <th>{"Total inc. Tax"|i18n("design/ezwebin/shop/confirmorder")}</th>
</tr>
<tr class="bglight">
    <td>
