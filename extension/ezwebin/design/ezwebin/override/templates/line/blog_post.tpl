...
<div class="content-view-line">
    ...
    <div class="attribute-byline">
        ...
        <div class="attribute-body float-break">
            <a href={$node.url_alias|ezurl} title="{$node.data_map.title.content|wash}">{attribute_view_gui attribute=$node.data_map.blog_image}</a>{attribute_view_gui attribute=$node.data_map.body}
        </div>
