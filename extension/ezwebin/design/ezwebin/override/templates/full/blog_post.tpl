                        ...
                        <div class="content-view-full">
                            <div class="class-blog-post float-break">
                                ...
                                <div class="attribute-byline">
                                    ...
                                    <p class="author"><a href="http://sandbox.speedhorse.com/userdetail/list/{$node.creator.id}">{$node.object.owner.name}</a></p>
                                ...
                                <div class="attribute-body float-break">
                                  {attribute_view_gui attribute=$node.data_map.blog_image}   {attribute_view_gui attribute=$node.data_map.body}
                                </div>
