...
{section show=eq( $#collection_attributes[$attribute.id].data_int, 0 ) }
    <div class="block">
    ...
    <div class="block">
        <input name="{$attribute_base}_ibCaptcha_captchaText_{$attribute.id}" type="text" size="{$attribute.contentclass_attribute.data_int1}" maxlength="{$attribute.contentclass_attribute.data_int1}" value="{$#collection_attributes[$attribute.id].data_text}" />
    </div>
...
{section show=eq( $#collection_attributes[$attribute.id].data_int, 1 ) }
    <p>{'Captcha`s secure code is allready entered'|i18n('ibcaptcha/object/edit')}</p>
    <input name="{$attribute_base}_ibCaptcha_captchaText_{$attribute.id}" type="hidden" value="{$#collection_attributes[$attribute.id].data_text}" />    
{/section}