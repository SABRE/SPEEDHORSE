<?php
//
// Definition of eZNetSOAPSync class
//
// Created on: <08-Nov-2005 23:41:00 hovik>
//
...
/*        $soapLogEntryList = eZNetSOAPLog::fetchByConds( array( 'class_name' => $this->ClassName,
    ...
    */
                             ...
                             $extendedFilter = false )
    {
        ...
        $eventClassMap = eZINI::instance( 'network.ini' )->variable( 'NotificationSettings', 'EventClassMap' );
