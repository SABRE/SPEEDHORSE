...
<h2>{'Tax is unknown'|i18n( 'design/standard/shop' )}</h2>
{'Tax percentage is not yet known for some of the items being purchased.'|i18n( 'design/standard/shop' )}<br/>
...
<tr>
	...
	<th>
	{"Price ex. Tax"|i18n("design/standard/shop")}
	</th>
	<th>
	{"Price inc. Tax"|i18n("design/standard/shop")}
	</th>
	<th>
	{"Discount"|i18n("design/standard/shop")}
	</th>
	<th>
	{"Total price ex. Tax"|i18n("design/standard/shop")}
	</th>
	<th>
	{"Total price inc. Tax"|i18n("design/standard/shop")}
	</th>
	<th>&nbsp;
...
<tr>
     ...
     <td>
     <b>{"Subtotal ex. Tax"|i18n("design/standard/shop")}</b>:
     </td>
     <td>
     <b>{"Subtotal inc. Tax"|i18n("design/standard/shop")}</b>:
     </td>
     <td>
     </td>
</tr>
