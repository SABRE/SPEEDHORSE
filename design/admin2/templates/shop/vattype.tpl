...
<h1 class="context-title">{'Tax types (%vat_types)'|i18n( 'design/admin/shop/vattype',, hash( '%vat_types', $vattype_array|count ) )}</h1>
...
<tr class="{$Vattypes.sequence}">
    <td><input type="checkbox" name="vatTypeIDList[]" value="{$Vattypes.item.id}" title="{'Select Tax type for removal.'|i18n( 'design/admin/shop/vattype' )}" /></td>
...
{section-else}
<div class="block">
<p>{'There are no Tax types.'|i18n( 'design/admin/shop/vattype' )}</p>
</div>
{/section}
...
<div class="button-left">
    {if $vattype_array}
    <input class="button" type="submit" name="RemoveVatTypeButton" value="{'Remove selected'|i18n( 'design/admin/shop/vattype' )}" title="{'Remove selected Tax types.'|i18n( 'design/admin/shop/vattype' )}" />
    {else}
    ...
    {/if}
    <input class="button" type="submit" name="AddVatTypeButton" value="{'New Tax type'|i18n( 'design/admin/shop/vattype' )}" title="{'Create a new Tax type.'|i18n( 'design/admin/shop/vattype' )}" />
</div>
