...
<div class="message-warning">
    ...
    {'Errors in Tax rules configuration may lead to charging wrong Tax for your products. Please fix them.'|i18n( 'design/admin/shop/vatrules' )}
</div>
{/if}
...
<h1 class="context-title">{'Tax charging rules (%rules)'|i18n( 'design/admin/shop/vatrules',, hash( '%rules', $rules|count ) )}</h1>
...
<tr>
    ...
    <th>{'Tax type'|i18n( 'design/admin/shop/vatrules' )}</th>
    <th class="tight">&nbsp;</th>
</tr>
...
{else}
<div class="block">
<p>{'There are no Tax charging rules.'|i18n( 'design/admin/shop/vatrules' )}</p>
</div>
{/if}
...
<div class="button-left">
    {if $rules}
    <input class="button" type="submit" name="RemoveRuleButton" value="{'Remove selected'|i18n( 'design/admin/shop/vatrules' )}" title="{'Remove selected Tax charging rules.'|i18n( 'design/admin/shop/vatrules' )}" />
    {else}
    ...
    {/if}
    <input class="button" type="submit" name="AddRuleButton" value="{'New rule'|i18n( 'design/admin/shop/vatrules' )}" title="{'Create a new Tax charging rule.'|i18n( 'design/admin/shop/vatrules' )}" />
</div>
<div class="break"></div>
</div>
